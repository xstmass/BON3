...
import com.mohistmc.bon3.cli.CLIErrorHandler;
...
import com.mohistmc.bon3.util.MappingVersions.MappingVersion;
    ...
    private static void parseArgs(String[] args) throws Exception {
        ...
        try {
            ...
            try {
                ...
                BON3Impl.remap(new File(inputJar), new File(outputJar), notch ? mcp : null, mapping, errorHandler, progress);
            } catch (Exception e) {
