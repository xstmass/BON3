...
import com.mohistmc.bon3.data.GuiDownloadNew;
import com.mohistmc.bon3.gui.BrowseListener;
import com.mohistmc.bon3.gui.GUIProgressListener;
import com.mohistmc.bon3.gui.JarDropTarget;
import com.mohistmc.bon3.gui.LinuxBrowseListener;
import com.mohistmc.bon3.gui.SimpleRefreshListener;
import com.mohistmc.bon3.gui.StartListener;
import com.mohistmc.bon3.util.BONUtils;
import com.mohistmc.bon3.util.DownloadUtils;
...
import com.mohistmc.bon3.util.MinecraftVersions;
import com.mohistmc.bon3.util.OSUtils;
...
public class BON3Gui extends JFrame {
    ...
    public BON3Gui() {
        ...
        JComboBox<MappingVersions.MappingVersion> cmbMappingVersions = new JComboBox<>();
        ...
        cmbMappingVersions.addActionListener(e -> {
            Object selected = cmbMappingVersions.getSelectedItem();
            if (selected == null) {
                prefs.remove(BON3Gui.PREFS_KEY_MAP_VERSION);
            } else {
                prefs.put(BON3Gui.PREFS_KEY_MAP_VERSION, selected.toString());
            }
        });

        btnMappingVerDownload.addActionListener(e -> {
            Map<MinecraftVersion, List<MappingVersions.MappingVersion>> data = MappingVersions.getKnownVersions();
            if (data.isEmpty()) {
                JOptionPane.showMessageDialog(BON3Gui.this, "No known Mapping Versions, check console log for details, or check your internet connection.", "Could not load mappings", JOptionPane.ERROR_MESSAGE);
                return;
            }
